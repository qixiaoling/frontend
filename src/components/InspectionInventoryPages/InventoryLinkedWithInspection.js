...
class InventoryLinkedWithInspection extends Component {
    ...
    addQuantity=(e)=>{
        ...
        InspectionInventoryService.addQuantity(this.state.idOne, this.state.idTwo, inspectionInventory,).then(res=>{
            this.props.history.push(`/view-inspection/${this.state.idOne}`);
        })
    }
    render(){
        return(
                        ...
                        <table >
                            ...
                            <tr>
                                ...
                                <td><input placeholder="0" name="inventoryQuantity"
                                           value={this.state.inventoryQuantities} onChange={this.changeInventoryQuantityHandler}/>
                                    <button className='btn--create-customer' onClick={this.addQuantity}>Add Quantity</button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
